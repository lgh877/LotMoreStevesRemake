...
import net.mcreator.lotmorestevesremake.entity.renderer.MiniZteveRenderer;
...
public class MiniZteveEntity extends LotmorestevesremakeModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			...
			.size(0.4f, 1.17f)).build("mini_zteve").setRegistryName("mini_zteve");

	public MiniZteveEntity(LotmorestevesremakeModElements instance) {
		super(instance, 33);
		FMLJavaModLoadingContext.get().getModEventBus().register(new MiniZteveRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16737844, -16750951, new Item.Properties().group(MeetTheStevesItemGroup.tab))
				.setRegistryName("mini_zteve_spawn_egg"));
	}
	...
	public void init(FMLCommonSetupEvent event) {
		EntitySpawnPlacementRegistry.register(entity, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES,
				(entityType, world, reason, pos, random) -> {
					...
					int y = pos.getY();
					int z = pos.getZ();
					return ZteveSpawnConditionProcedure.executeProcedure(Stream
	...
	public static class CustomEntity extends ZteveEntity.CustomEntity {
